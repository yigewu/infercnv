...
snRNA_aliquot_id=CPT0001180011
...
cutoff=0.04
ref_group_names=Ref_SmallNumber,Macrophages,CD4.CD8.proliferating,Plasma.cells,Endothelial.cells,Myofibroblasts,Loop.of.Henle
