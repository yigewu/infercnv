...
snRNA_aliquot_id=CPT0001220012
...
cutoff=0.04
ref_group_names=CD4..T.cells,Macrophages,Mixed.myeloid.lymphoid,TRM,Ref_SmallNumber,NK.cells,CD8..T.cells.exhausted,B.cells,Endothelial.cells,Fibroblasts
