...
snRNA_aliquot_id=CPT0001260013
...
cutoff=0.04
ref_group_names=CD4..T.cells,CD8..T.cells.exhausted,Ref_SmallNumber,NK.cells,Macrophages,Mixed.myeloid.lymphoid,TRM,CD4.CD8.proliferating,Tregs,cDC,Plasma.cells,Endothelial.cells,Myofibroblasts,Fibroblasts
