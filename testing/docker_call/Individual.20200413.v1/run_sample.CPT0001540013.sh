...
snRNA_aliquot_id=CPT0001540013
...
cutoff=0.04
ref_group_names=Macrophages,CD4..T.cells,CD8..T.cells.activated,CD8..T.cells.exhausted,NK.cells,Tregs,Ref_SmallNumber,Mixed.myeloid.lymphoid,TRM,CD4.CD8.proliferating,cDC,B.cells,Endothelial.cells,Myofibroblasts
