...
snRNA_aliquot_id=CPT0010100001
...
cutoff=0.04
ref_group_names=Ref_SmallNumber,CD8..T.cells.activated,Macrophages,Mixed.myeloid.lymphoid,TRM,cDC,Endothelial.cells,Myofibroblasts
