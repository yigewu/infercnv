...
cutoff=0.04
ref_group_names=CD4..T.cells,Macrophages,CD8..T.cells.activated,Ref_SmallNumber,Mixed.myeloid.lymphoid,NK.cells,B.cells,CD4.CD8.proliferating,cDC,Plasma.cells,Endothelial.cells,Myofibroblasts,Fibroblasts
