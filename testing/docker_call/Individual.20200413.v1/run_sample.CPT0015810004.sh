...
snRNA_aliquot_id=CPT0015810004
...
cutoff=0.04
ref_group_names=CD4..T.cells,CD8..T.cells.activated,CD4.CD8.proliferating,Macrophages,Mixed.myeloid.lymphoid,Ref_SmallNumber,NK.cells,Tregs,cDC,Endothelial.cells,Myofibroblasts
