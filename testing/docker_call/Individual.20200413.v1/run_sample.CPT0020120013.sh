...
cutoff=0.04
ref_group_names=Macrophages,CD4..T.cells,CD8..T.cells.exhausted,NK.cells,Tregs,Macrophages.M2b,Mixed.myeloid.lymphoid,CD4.CD8.proliferating,Ref_SmallNumber,cDC,B.cells,Endothelial.cells,Myofibroblasts,Fibroblasts,Proximal.tubule
