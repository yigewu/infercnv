...
snRNA_aliquot_id=CPT0023690004
...
cutoff=0.04
ref_group_names=CD4..T.cells,Macrophages,CD8..T.cells.exhausted,Ref_SmallNumber,NK.cells,Mixed.myeloid.lymphoid,CD4.CD8.proliferating,cDC,Endothelial.cells,Myofibroblasts,Fibroblasts
