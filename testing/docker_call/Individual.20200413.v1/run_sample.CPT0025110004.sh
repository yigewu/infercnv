...
snRNA_aliquot_id=CPT0025110004
...
cutoff=0.04
ref_group_names=CD4..T.cells,Ref_SmallNumber,Macrophages,NK.cells,Mixed.myeloid.lymphoid,TRM,CD4.CD8.proliferating,Endothelial.cells,Myofibroblasts
