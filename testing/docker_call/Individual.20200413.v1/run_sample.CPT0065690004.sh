...
snRNA_aliquot_id=CPT0065690004
...
cutoff=0.04
ref_group_names=CD4..T.cells,Ref_SmallNumber,Macrophages,CD8..T.cells.exhausted,Mixed.myeloid.lymphoid,NK.cells,Tregs,cDC,Endothelial.cells,Myofibroblasts
