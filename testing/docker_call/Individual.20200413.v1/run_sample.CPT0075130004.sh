...
snRNA_aliquot_id=CPT0075130004
...
cutoff=0.04
ref_group_names=Macrophages,CD4..T.cells,Ref_SmallNumber,Mixed.myeloid.lymphoid,CD4.CD8.proliferating,Tregs,TRM,cDC,Endothelial.cells,Myofibroblasts,Fibroblasts
