...
cutoff=0.04
ref_group_names=Macrophages,Mixed.myeloid.lymphoid,TRM,Ref_SmallNumber,CD4..T.cells,NK.cells,Tregs,CD4.CD8.proliferating,cDC,Plasma.cells,Endothelial.cells,Myofibroblasts,Proximal.tubule
