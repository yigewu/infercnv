...
cutoff=0.04
ref_group_names=Macrophages,Ref_SmallNumber,TRM,Endothelial.cells,Myofibroblasts,Loop.of.Henle,Proximal.tubule,Distal.convoluted.tubule,Intercalated.cells.type.B,Intercalated.cells.type.A
