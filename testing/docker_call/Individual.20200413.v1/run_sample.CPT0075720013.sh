...
snRNA_aliquot_id=CPT0075720013
...
cutoff=0.04
ref_group_names=Ref_SmallNumber,Macrophages,cDC,Endothelial.cells,Myofibroblasts,Fibroblasts,Proximal.tubule,Loop.of.Henle,Distal.convoluted.tubule,Podocytes,Intercalated.cells.type.A
