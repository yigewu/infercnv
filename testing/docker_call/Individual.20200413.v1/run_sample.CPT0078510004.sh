...
snRNA_aliquot_id=CPT0078510004
...
cutoff=0.04
ref_group_names=CD4..T.cells,Macrophages,Ref_SmallNumber,NK.cells,TRM,CD4.CD8.proliferating,Mixed.myeloid.lymphoid,Endothelial.cells,Myofibroblasts,Fibroblasts
