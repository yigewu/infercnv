...
cutoff=0.04
ref_group_names=Macrophages.M2b,Macrophages,CD4..T.cells,Ref_SmallNumber,CD8..T.cells.exhausted,Mixed.myeloid.lymphoid,NK.cells,TRM,Tregs,cDC,B.cells,Plasma.cells,Endothelial.cells,Myofibroblasts,Fibroblasts
