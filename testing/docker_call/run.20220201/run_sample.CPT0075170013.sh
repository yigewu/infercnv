...
snRNA_aliquot_id=CPT0075170013
...
mkdir -p ${dir_output}
dir_raw_count_file=${dir_infercnv_inputs}raw_counts_matrix/doublets_removed/
path_raw_count_file=${dir_raw_count_file}${snRNA_aliquot_id}.RNA_Count.tsv
dir_annotation_file=${dir_infercnv_inputs}annotations_file/${run_id}/
...
cutoff=0.04
ref_group_names=Ref
docker run -v ${dir_run}:${dir_run} --ulimit stack=8277716992:8277716992 ${docker_image_name} inferCNV.R \
